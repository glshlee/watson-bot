...
### Phase 4: 웹 대시보드 및 지능형 비서 엔진 (Watson Butler) - 🚀 진행 중 / 고도화
...
- [ ] 지능형 비서 의도 분석 및 대화-기록 분리 (ADR-004): 단순 대화 보존 vs 라이프로그 능동 제안
- [ ] 세션 상태 머신 기반 `pending_log` 후보 관리 및 승인 시 1기록 1커밋 자동 파이프라인
